                                    ...
                                    <table id="ordersTable" style="width: 100%;" class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="padding: 10px 10px;" style="width: 15%;">Status</th>
        ...
        $(document).ready(function(){
            ...
            var table = $('#ordersTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'totalProduct', name: 'totalProduct', className: 'align-middle', width: '12%'},
                    {data: 'details', name: 'details', className: 'align-middle', width: '15%'},
                    {data: 'statusProduct', name: 'statusProduct', orderable: false, width: '15%', className: 'align-middle'}, 
